...
if(localStorage.getItem('content')){
    const getLength = JSON.parse(localStorage.getItem('content'))
    if(getLength.length === 1){
        let containedText = document.createElement('p');
        containedText.innerText = getLength[0].containedText
        ...
        inputEditText.setAttribute('value', getLength[0].containedText)
